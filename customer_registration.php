...
<!-- register -->
	<div class="register">
		<div class="container">
			...
			<form id="signup_form" action="register.php">
				...
				<div class="animated wow slideInUp" data-wow-delay=".5s">
					...
					<input type="password"  id="repassword" name="repassword" class="form-control" placeholder="Password Confirmation" required=" " >
				...
				<h6 class="animated wow slideInUp" data-wow-delay=".5s">Private Information</h6>
				<div class="animated wow slideInUp" data-wow-delay=".5s">
					<input type="text" id="mobile" name="mobile" class="form-control" placeholder="Mobile number"  >
					<input type="text" id="address1" name="address1" class="form-control" placeholder="1st Address"  >
					<input type="text" placeholder="2nd adress" id="address2" name="address2" class="form-control" >
					<div class="register-check-box">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox"><i> </i>All the field are true</label>
						</div>
					</div>
				</div>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="copy-right animated wow slideInUp" data-wow-delay=".5s">
				<p>&copy 2016 Best Store. All rights reserved Amel Jbeli</p>
			</div>
		</div>
	</div>
<!-- //footer -->
