	...
	<link rel="stylesheet" type="text/css" href="style.css">
		...
		<style>
			@media screen and (max-width:480px){
				#search{width:80%;}
				#search_btn{width:30%;float:right;margin-top:-32px;margin-right:5000px;}
			}
		</style>
	</head>
<body>
		...
		<div class="container">
			<div class="header-grid">
				<div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<ul >
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">amel.jbeli@yahoo.fr</a></li>
			...
			<div class="logo-nav">
				...
				<div class="logo-nav-left1">
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="logout.php" ><span class="glyphicon glyphicon-log-out" aria-hidden="true">Logout</a></li>
					</ul>
				</li>
